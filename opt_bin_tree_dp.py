...
P = [histogram[word][1] for word in D]

unsuccesful = find_unsuccessful_searches(P)
print("Size of unsuccessful list:", len(unsuccesful))
print("Size of unsuccessful list:", len(P))
opt = opt_bin_tree( D, P, unsuccesful )
print(opt)
